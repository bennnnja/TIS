...
<head>
    ...
    <title>Autentificacion | Gelateria Milano</title>
        ...
        <main>
            ...
            <div class="contenedor__todo">
                ...
                <div class="contenedor__login-register">
                    <!--Login-->
                    <form action="InicioSesion.php" method="post" class="formulario__login">
                    ...
                    <form action="Registrarse.php" method="post" class="formulario__register">
                        ...
                        <input type="number" id="rut" name="rut" placeholder="RUT">
                        <input type="email" id="email" name="email" placeholder="Correo Electronico">
