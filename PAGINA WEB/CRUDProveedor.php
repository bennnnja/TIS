    ...
    <article>
        <section class="form-edit">
            ...
            $busqueda = $_GET['busqueda'];
                ...
                {
                    $where="WHERE CAST(telefono AS TEXT) LIKE'%".$busqueda."%' OR nombre_proveedor  LIKE'%".$busqueda."%' OR email_proveedor  LIKE'%".$busqueda."%' OR ubicacion  LIKE'%".$busqueda."%' OR CAST(cod_proveedor AS TEXT)  LIKE'%".$busqueda."%'";
                }
            ...
            $conexion=pg_connect("host=magallanes.inf.unap.cl dbname=brojas user=brojas password=Gt95x5cDq1");            
            $encuentro=pg_query($conexion,"SELECT nombre_proveedor, cod_proveedor, telefono, email_proveedor, ubicacion FROM proveedor $where");
            ...
            <td>
                ...
                <a class="btn btn-warning" href="editar_proveedor.php?id=<?php echo $fila['cod_proveedor']?> ">
                <i class="fa fa-edit"></i> </a>
                </button>

                <a class="btn btn-danger btn-del" href="eliminar_proveedor.php?codigo_proveedor=<?php echo $fila['cod_proveedor']; ?>">
