...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(25, 10, utf8_decode('FECHA PEDIDO'), 1, 0, 'C', 1);
      $this->Cell(70, 10, utf8_decode('EMAIL'), 1, 0, 'C', 1);
      $this->Cell(25, 10, utf8_decode('CODIGO CLIENTE'), 1, 1, 'C', 1);
      $this->Cell(25, 10, utf8_decode('ACCIONES'), 1, 1, 'C', 1);       //CAMBIAR VALORESSSSSSS
   }
